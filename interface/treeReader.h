...
class treeReader {
    public :
        ...
        bool jetIsGood(const unsigned, const unsigned ptCut = 25, const unsigned unc = 0, const bool clean = true, const double eta = 2.4);
        unsigned nJets(const unsigned unc, const bool clean, std::vector<unsigned>&, const double eta = 2.4);
        ...
        unsigned nBJets(const unsigned unc, const bool deepCSV, const bool clean, std::vector<unsigned>& ind, const unsigned wp);
        double HTCalc(const std::vector<unsigned>& ind);
		  bool deltaRCalcForWS(const std::vector<unsigned>& ind, unsigned & lept);
