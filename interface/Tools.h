...
void initListToPrint(const std::string & selection){
  ...
  listToPrint["ttZclean"] = {"ptlead", "sublead", "trail", "njets", "nbjets", "mll", "ptZ", "ptNonZ", "met", "cosThetaStar", "SRttZCleanPTZ", "SRttZCleanCosTheta", "flavour3L", "flavour4L", "flavour3L4L", "mllnoZcut", "topPt", "lepTopMass", "hadTopMass", "hadWMass", "lepTopPt", "hadTopPt"};
  ...
  listToPrint["ttZ"] = {"SRallTTZ", "SR3L", "SR4L", "SRWZCR", "SRZZCR", "SRTTCR", "SR3L3m", "SR3L2m1e", "SR3L1m2e", "SR3L3e", "SRTTZ8SR3L", "flavour3L4L", "ptlead", "trail", "topPt", "HT", "lepTopMass", "hadTopMass", "hadWMass", "lepTopPt", "hadTopPt"};
