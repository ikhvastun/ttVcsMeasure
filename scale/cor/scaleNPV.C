...
void scaleNPV(){
	...
	*/
	...
	h1 = (TH1D*) _file0->Get("scaleChoice_0");
	h2 = (TH1D*) _file1->Get("scaleChoice_0");
	h3 = (TH1D*) _file2->Get("scaleChoice_0");
	h4 = (TH1D*) _file3->Get("scaleChoice_0");
...
/*
	leg->AddEntry(h1,"Type I E_{T}^{miss} Z#rightarrow#mu#mu", "l");
	leg->AddEntry(h2,"Type I E_{T}^{miss} Z#rightarrow#mu#mu NPV [0,18]", "l");
	leg->AddEntry(h3,"Type I E_{T}^{miss} Z#rightarrow#mu#mu NPV [18,32]", "l");
	leg->AddEntry(h4,"Type I E_{T}^{miss} Z#rightarrow#mu#mu NPV [32,inf]", "l");
*/
	leg->AddEntry(h1,"Type I E_{T}^{miss} Z#rightarrow ee", "l");
	leg->AddEntry(h2,"Type I E_{T}^{miss} Z#rightarrow ee NPV [0,18]", "l");
	leg->AddEntry(h3,"Type I E_{T}^{miss} Z#rightarrow ee NPV [18,32]", "l");
	leg->AddEntry(h4,"Type I E_{T}^{miss} Z#rightarrow ee NPV [32,inf]", "l");
	leg->Draw("same");
