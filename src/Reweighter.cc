...
void Reweighter::initializeFakeRate(){
    ...
    TFile* frFileEl = TFile::Open("data/FRmaps/elFR_data_QCD_Marek_" + TString(is2016 ? "2016" : "2017") + ".root");
    TFile* frFileMu = TFile::Open("data/FRmaps/muFR_data_QCD_Marek_" + TString(is2016 ? "2016" : "2017") + ".root");
    //TFile* frFileEl = TFile::Open("data/FRmaps/elFR_data_" + TString(is2016 ? "2016" : "2017") + ".root");
    //TFile* frFileMu = TFile::Open("data/FRmaps/muFR_data_" + TString(is2016 ? "2016" : "2017") + ".root");
