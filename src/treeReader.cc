...
void treeReader::initSample(){
    ...
    sampleFile = std::make_shared<TFile>("/user/ikhvastu/Work/ntuples_checkLeptonMVA/samplesForTraining/2016MC/"+ (const TString&) std::get<1>(samples[currentSample]),"read");  // 
